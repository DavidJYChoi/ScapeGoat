...
//            System.out.println("=================");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(-1* (Math.log(7))/Math.log(0.58));
         **/
//        tree.add(new T(40));
//        System.out.println("----------------------");
...
//        tree.add(new T(8));
//        System.out.println(tree.inorder(tree.root));
//        System.out.println("expected [[8 0], [10,0], [40, 0]");
//        System.out.println("----------------------");
        tree.add(new T(6));
        tree.add(new T(5));
...
//        tree.add(new T(1));
//        tree.add(new T(0));
        //tree.root = tree.rebuild(tree.root);
//        tree.remove(new T(10));
//        tree.remove(new T(12));
//        tree.remove(new T(18));
//        tree.remove(new T(20));
        tree.printTree(tree.root);
        System.out.println(tree.inorder(tree.root));
        //System.out.println(tree.NodeCount);
        System.out.println(tree.getHeight(tree.root));
        System.out.println(tree.MaxNodeCount);
        System.out.println(tree.NodeCount);
